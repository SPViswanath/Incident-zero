...
export default function Reports() {
  ...
  if (loading) {
    return (
      <div className="h-full flex items-center justify-center text-slate-500">
        <Activity className="animate-spin mr-3 text-[#ffffff]" /> Loading Reports...
      </div>
    );
  }
  ...
  return (
    <div className="w-full relative h-full flex flex-col pt-2 md:pt-6 px-4 md:px-10">
      ...
      {reports.length === 0 ? (
         <div className="flex flex-col items-center justify-center py-20 bg-[#18181b]/50 rounded-3xl border border-[#3f3f46]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {reports.map((report) => (
            <div key={report.id} className="bg-[#27272a]/60 backdrop-blur-md border border-[#3f3f46]/50 rounded-[28px] p-6 hover:bg-[#27272a]/80 transition-all duration-300 flex flex-col relative overflow-hidden group">
              <div className="flex justify-between items-start mb-4">
                <span className="px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase border tracking-widest text-[#ffffff] border-[#ffffff]/30 bg-[#ffffff]/10 flex items-center gap-1.5">
              ...
              <h3 className="text-lg md:text-xl font-bold mb-3 text-white group-hover:text-[#ffffff] transition-colors leading-tight line-clamp-2">
              ...
              <div className="mt-auto border-t border-[#3f3f46] pt-4 flex justify-between items-center">
                <span className="text-[10px] font-bold tracking-[0.2em] text-[#ffffff] uppercase bg-[#000000]/50 px-2.5 py-1 rounded-md border border-[#27272a]">
